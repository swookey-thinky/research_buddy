...
check_empty "search_query" "$search_query"
...
python3 $python_script_path --recipient_email "$recipient_email" --subject_title "$subject_title" --header_title "$header_title" --search_query "$search_query"
deactivate
rm -rf $temp_dir